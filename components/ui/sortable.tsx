...
type SortableChildElement = React.ReactElement<{
  value: string;
  className?: string;
}>;
        ...
        {activeId ? (
          <div className="z-50">
            {React.Children.map(children, (child) => {
              ...
              const element = child as SortableChildElement;
              if (element.props.value !== activeId) return null;

              return React.cloneElement(element, {
                ...element.props,
                className: cn(element.props.className, "z-50 shadow-lg"),
              });
            })}
          </div>
        ) : null}
